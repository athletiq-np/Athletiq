// src/components/features/athlete/EditAthleteModal.jsx
import React, { useState, useEffect } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { FaTimes, FaEdit, FaGraduationCap, FaHome, FaPhone, FaCalendarAlt, FaMale, FaFemale, FaSave } from 'react-icons/fa';
import { toast } from 'react-toastify';

export default function EditAthleteModal({ isOpen, onClose, onSubmit, student, houses = [] }) {
          ...
          <div className={`flex items-center justify-between p-6 border-b border-gray-200 ${genderStyle.bgColor}`}>
            <div className="flex items-center space-x-3">
              <div className="bg-white p-3 rounded-xl shadow-sm">
                <FaEdit className="h-6 w-6 text-gray-600" />
              </div>
              <div>
                <h2 className={`text-2xl font-bold ${genderStyle.textColor}`}>Edit Student</h2>
