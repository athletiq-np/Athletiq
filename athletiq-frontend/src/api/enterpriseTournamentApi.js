...
export const createTournament = async (tournamentData) => {
  try {
    ...
    const response = await apiClient.post(API_ENDPOINTS.TOURNAMENTS.BASE, finalData);
...
export const getTournaments = async (filters = {}) => {
  try {
    ...
    const response = await apiClient.get(`${API_ENDPOINTS.TOURNAMENTS.BASE}?${params.toString()}`);
...
export const updateTournament = async (id, updateData) => {
  try {
    ...
    const response = await apiClient.put(`${API_ENDPOINTS.TOURNAMENTS.BASE}/${id}`, finalData);
...
export const updateTournamentStatus = async (id, status) => {
  try {
    ...
    const response = await apiClient.patch(`${API_ENDPOINTS.TOURNAMENTS.BASE}/${id}/status`, { status });
...
export const getTournamentAnalytics = async (id) => {
  try {
    ...
    const response = await apiClient.get(`${API_ENDPOINTS.TOURNAMENTS.BASE}/${id}/analytics`);
...
export const generateTournamentBrackets = async (id) => {
  try {
    ...
    const response = await apiClient.post(`${API_ENDPOINTS.TOURNAMENTS.BRACKET(id)}/generate`);
