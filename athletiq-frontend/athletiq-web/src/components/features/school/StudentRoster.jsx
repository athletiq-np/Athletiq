...
import ViewAthleteModal from '@features/athlete/ViewAthleteModal';
import BulkAthleteUploadModal from '@features/athlete/BulkAthleteUploadModal';
...
export default function StudentRoster({ students, houses, onRefresh, filters, setFilters, globalSearch }) {
  ...
  const filteredAndSortedStudents = useMemo(() => {
    let filtered = displayStudents.filter(student => {
      ...
      return matchesSearch && matchesGrade && matchesSection && matchesHouse;
    });
    ...
    return filtered;
  }, [displayStudents, searchTerm, gradeFilter, sectionFilter, houseFilter, sortBy, sortOrder]);
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <button
            ...
            disabled={loading}
            className="bg-athletiq-blue text-white px-4 py-2 rounded-lg hover:bg-athletiq-navy transition-colors flex items-center space-x-2 disabled:opacity-50"
          >
      ...
      <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          ...
          <button 
            ...
            className="text-sm text-athletiq-blue hover:text-athletiq-navy"
          >
            Reset Filters
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <select 
            ...
            className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-athletiq-blue focus:border-transparent"
          >
      ...
      <div className="flex items-center justify-between">
        <div className="text-sm text-gray-700">
          ...
          <span className="font-medium">{Math.min(startIndex + itemsPerPage, filteredAndSortedStudents.length)}</span> of{' '}
