...
import AthleteProfile from '@/components/features/athlete/AthleteProfile';
...
const ComponentShowcase = () => {
  ...
  const components = [
    ...
    },
    {
      ...
      description: 'Athlete information and document management',
      component: <AthleteProfile athleteId="demo-athlete" isEditable={true} />
    }
  ];
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1">
                        {['DocumentUpload', 'AthleteProfile', 'AdminDashboard', 'AnalyticsDashboard', 'AdminNavigation'].map(comp => (
